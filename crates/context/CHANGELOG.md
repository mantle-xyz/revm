...
## [16.1.0](https://github.com/mantle-xyz/revm/compare/revm-context-v16.0.1...revm-context-v16.1.0) - 2026-08-04
...
- Add Str(Cow<'static, str>) to InvalidTransaction error enum ([#2998](https://github.com/mantle-xyz/revm/pull/2998))
- allow EIP-7623 to be disabled ([#2985](https://github.com/mantle-xyz/revm/pull/2985))
- Introduced `all_mut` and `all` functions to ContextTr ([#2992](https://github.com/mantle-xyz/revm/pull/2992))
...
- add generic state to ResultAndState ([#2897](https://github.com/mantle-xyz/revm/pull/2897))
- short address for journal cold/warm check ([#2849](https://github.com/mantle-xyz/revm/pull/2849))
- implement `Transaction` for `Either` ([#2662](https://github.com/mantle-xyz/revm/pull/2662))
...
- add builder pattern for TxEnv ([#2518](https://github.com/mantle-xyz/revm/pull/2518))
- make Journal::set_code to be EIP-7702 zero address bytecode aware ([#2511](https://github.com/mantle-xyz/revm/pull/2511))
...
- add chain_ref method to ContextTr trait ([#2450](https://github.com/mantle-xyz/revm/pull/2450))
...
- added with_ref_db fn to Context ([#2164](https://github.com/mantle-xyz/revm/pull/2164))
- remove specification crate ([#2165](https://github.com/mantle-xyz/revm/pull/2165))
- make journal entries generic ([#2154](https://github.com/mantle-xyz/revm/pull/2154))
- Standalone Host, remove default fn from context ([#2147](https://github.com/mantle-xyz/revm/pull/2147))
- add constructor with hardfork ([#2135](https://github.com/mantle-xyz/revm/pull/2135))
- implement AccessListTr for Vec ([#2136](https://github.com/mantle-xyz/revm/pull/2136))
- allow host to be implemented on custom context ([#2112](https://github.com/mantle-xyz/revm/pull/2112))
- add the debug impl for Evm and EvmData type ([#2126](https://github.com/mantle-xyz/revm/pull/2126))
...
- *(eip7702)* devnet6 changes and bump eest tests ([#2055](https://github.com/mantle-xyz/revm/pull/2055))
...
- *(ee/handler)* compile failed-deposit logs change under no_std + tests
- *(op-revm)* persist BVM_ETH mint log on failed deposit receipts
- use access list to decide if slot is cold ([#3149](https://github.com/mantle-xyz/revm/pull/3149))
- *(context)* avoid double reference in `Context::all()` ([#3131](https://github.com/mantle-xyz/revm/pull/3131))
...
- EIP-7702 target check to return correct error ([#2896](https://github.com/mantle-xyz/revm/pull/2896))
- correct various typos in documentation and comments ([#2855](https://github.com/mantle-xyz/revm/pull/2855))
- swapped comments for db and db_mut methods in JournalTr trait ([#2774](https://github.com/mantle-xyz/revm/pull/2774))
- fully deprecate serde-json ([#2767](https://github.com/mantle-xyz/revm/pull/2767))
- fix typo: Rename is_created_globaly to is_created_globally ([#2692](https://github.com/mantle-xyz/revm/pull/2692))
...
- use HashMap::default in LocalContext ([#2451](https://github.com/mantle-xyz/revm/pull/2451))
- fix typo and update links ([#2387](https://github.com/mantle-xyz/revm/pull/2387))
- Effective gas price should check tx type ([#2375](https://github.com/mantle-xyz/revm/pull/2375))
- remove duplicated load_account() ([#2225](https://github.com/mantle-xyz/revm/pull/2225))
- correct propagate features ([#2177](https://github.com/mantle-xyz/revm/pull/2177))
- clear JournalState and set first journal vec ([#1929](https://github.com/mantle-xyz/revm/pull/1929))
- Clear journal ([#1927](https://github.com/mantle-xyz/revm/pull/1927))
...
- Merge origin/main into mantle-elysium
...
- journal transfer fn cleanup ([#3085](https://github.com/mantle-xyz/revm/pull/3085))
...
- make precompile error pub ([#3057](https://github.com/mantle-xyz/revm/pull/3057))
...
- remove unreachable zero-denominator check in fake_exponential ([#3039](https://github.com/mantle-xyz/revm/pull/3039))
- add ensure_enough_balance helper ([#3033](https://github.com/mantle-xyz/revm/pull/3033))
- add default impl for tx_local_mut and tx_journal_mut ([#3029](https://github.com/mantle-xyz/revm/pull/3029))
...
- skip drain if checkpoing is inconsistent ([#2911](https://github.com/mantle-xyz/revm/pull/2911))
...
- make ci happy ([#2863](https://github.com/mantle-xyz/revm/pull/2863))
...
- rm redundant lifetime constraints ([#2850](https://github.com/mantle-xyz/revm/pull/2850))
...
- add comprehensive tests for TxEnvBuilder ([#2690](https://github.com/mantle-xyz/revm/pull/2690))
...
- include local context as generic ([#2645](https://github.com/mantle-xyz/revm/pull/2645))
...
- optimize warm_preloaded_addresses reset ([#2625](https://github.com/mantle-xyz/revm/pull/2625))
...
- *(docs)* context crate lints ([#2565](https://github.com/mantle-xyz/revm/pull/2565))
...
- add dot to trigger ci ([#2552](https://github.com/mantle-xyz/revm/pull/2552))
...
- remove default capacity on journal reverts ([#2449](https://github.com/mantle-xyz/revm/pull/2449))
- *(journal)* flatten journal entries ([#2440](https://github.com/mantle-xyz/revm/pull/2440))
- clone_from precompile addresses ([#2438](https://github.com/mantle-xyz/revm/pull/2438))
...
- set gas_priority_fee to None in TxEnv ([#2371](https://github.com/mantle-xyz/revm/pull/2371))
...
- pre EIP-7702 does not need to load code ([#2162](https://github.com/mantle-xyz/revm/pull/2162))
...
- Adding function derive_tx_type to TxEnv ([#2118](https://github.com/mantle-xyz/revm/pull/2118))
- fix eofcreate error typo ([#2120](https://github.com/mantle-xyz/revm/pull/2120))
- remove wrong `&mut`/`TODO`, and avoid useless `get_mut` ([#2111](https://github.com/mantle-xyz/revm/pull/2111))
...
- rm database from context-interface ([#2087](https://github.com/mantle-xyz/revm/pull/2087))
...
- simplify some generics ([#2032](https://github.com/mantle-xyz/revm/pull/2032))
- Add helper functions for JournalInit #1879 ([#1961](https://github.com/mantle-xyz/revm/pull/1961))
- fix journal naming for inc/dec balance ([#1976](https://github.com/mantle-xyz/revm/pull/1976))
