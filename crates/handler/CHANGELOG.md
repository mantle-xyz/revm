...
## [19.0.0](https://github.com/mantle-xyz/revm/compare/revm-handler-v18.1.0...revm-handler-v19.0.0) - 2026-08-04

### Added

- propagate InitialAndFloorGas to validate_against_state_and_deduct_caller ([#3577](https://github.com/mantle-xyz/revm/pull/3577))
...
- *(gas_params)* add configurable EIP-7702 auth refund ([#3366](https://github.com/mantle-xyz/revm/pull/3366))
...
- Restrict Database::Error. JournaledAccountTr ([#3199](https://github.com/mantle-xyz/revm/pull/3199))
...
- JournaledAccount, a nice way to update and track changes ([#3086](https://github.com/mantle-xyz/revm/pull/3086))
- dont load access list immediately ([#3116](https://github.com/mantle-xyz/revm/pull/3116))
...
- add transaction index to batch execution error handling ([#3000](https://github.com/mantle-xyz/revm/pull/3000))
...
- add optional priority fee check configuration ([#2588](https://github.com/mantle-xyz/revm/pull/2588))
...
- remove spec id verification on `apply_eip7702_auth_list` ([#2466](https://github.com/mantle-xyz/revm/pull/2466))
...
- cache precompile warming ([#2317](https://github.com/mantle-xyz/revm/pull/2317))
- provide more context to precompiles ([#2318](https://github.com/mantle-xyz/revm/pull/2318))
...
- Add tx/block to EvmExecution trait ([#2195](https://github.com/mantle-xyz/revm/pull/2195))
- decouple first_frame_input from inspector ([#2180](https://github.com/mantle-xyz/revm/pull/2180))
- *(handler)* add MainnetContext alias generic over Database ([#2166](https://github.com/mantle-xyz/revm/pull/2166))
...
- Introduce Auth and AccessList traits ([#2079](https://github.com/mantle-xyz/revm/pull/2079))
...
- removed create address collision check ([#1928](https://github.com/mantle-xyz/revm/pull/1928))
...
- reject transactions with nonce at u64::MAX ([#3553](https://github.com/mantle-xyz/revm/pull/3553))
- *(handler)* respect is_fee_charge_disabled in calculate_caller_fee ([#3401](https://github.com/mantle-xyz/revm/pull/3401))
...
- interpreter_result_mut should return mutable reference ([#2941](https://github.com/mantle-xyz/revm/pull/2941))
- FrameStack mark push/end_init as unsafe ([#2929](https://github.com/mantle-xyz/revm/pull/2929))
...
- system call should have 30M gas limit ([#2755](https://github.com/mantle-xyz/revm/pull/2755))
...
- *(eof)* extdelegate bytecode check after eip7702 load ([#2417](https://github.com/mantle-xyz/revm/pull/2417))
...
- broken disable balance check ([#2286](https://github.com/mantle-xyz/revm/pull/2286))
- *(op)* fix inspection call ([#2184](https://github.com/mantle-xyz/revm/pull/2184))
...
- call clear ([#2091](https://github.com/mantle-xyz/revm/pull/2091))
- *(Inspector)* frame_end called multiple times ([#2037](https://github.com/mantle-xyz/revm/pull/2037))
- *(Inspector)* call handler functions ([#2026](https://github.com/mantle-xyz/revm/pull/2026))
- deduplicate validate_initial_tx_gas API ([#2006](https://github.com/mantle-xyz/revm/pull/2006))
...
- *(handler)* rename misleading `underflow` variable to `success` ([#3486](https://github.com/mantle-xyz/revm/pull/3486))
...
- *(handler)* remove Default for EthPrecompiles and EthInstructions ([#3434](https://github.com/mantle-xyz/revm/pull/3434))
- remove unused alloy-provider dev-dependency ([#3423](https://github.com/mantle-xyz/revm/pull/3423))
- [**breaking**] add logs to Revert and Halt variants of ExecutionResult ([#3424](https://github.com/mantle-xyz/revm/pull/3424))
- [**breaking**] add ResultGas struct to ExecutionResult ([#3413](https://github.com/mantle-xyz/revm/pull/3413))
...
- *(handler)* extract duplicate ContextError handling ([#3312](https://github.com/mantle-xyz/revm/pull/3312))
- *(revm-handler)* add ItemOrResult::map_item (alias map_frame) ([#3320](https://github.com/mantle-xyz/revm/pull/3320))
...
- description of `Handler::validate_against_state_and_deduct_caller` should match responsibilities ([#3256](https://github.com/mantle-xyz/revm/pull/3256))
- *(handler)* eliminate code duplication in transaction validation ([#3243](https://github.com/mantle-xyz/revm/pull/3243))
- *(handler)* validate_initial_tx_gas takes &mut Evm  ([#3235](https://github.com/mantle-xyz/revm/pull/3235))
...
- apply_auth_list helper fn ([#3187](https://github.com/mantle-xyz/revm/pull/3187))
...
- *(op)* use helper function in validate against state ([#3069](https://github.com/mantle-xyz/revm/pull/3069))
- remove redundant alloy-eip7702 from handler dev-dependencies ([#3105](https://github.com/mantle-xyz/revm/pull/3105))
...
- *(handler)* extract duplicate gas price validation ([#3045](https://github.com/mantle-xyz/revm/pull/3045))
...
- helper calculate_caller_fee ([#3040](https://github.com/mantle-xyz/revm/pull/3040))
...
- Frame use From in place of Into ([#3036](https://github.com/mantle-xyz/revm/pull/3036))
...
- Fix infinite recursion in EthPrecompiles PrecompileProvider methods ([#2962](https://github.com/mantle-xyz/revm/pull/2962))
- add SECURITY.md ([#2956](https://github.com/mantle-xyz/revm/pull/2956))
- update `EthFrame::invalid` visibility ([#2947](https://github.com/mantle-xyz/revm/pull/2947))
- remove unused generic from validate_tx_env and fix call site ([#2946](https://github.com/mantle-xyz/revm/pull/2946))
...
- rm commented code ([#2839](https://github.com/mantle-xyz/revm/pull/2839))
...
- fix run-tests.sh ([#2801](https://github.com/mantle-xyz/revm/pull/2801))
...
- remove State bound from JournalTr in Handler::Evm ([#2715](https://github.com/mantle-xyz/revm/pull/2715))
...
- document external state transitions for EIP-4788 and EIP-2935 ([#2678](https://github.com/mantle-xyz/revm/pull/2678))
- minor fixes ([#2686](https://github.com/mantle-xyz/revm/pull/2686))
- fix in pre_execution.rs about nonce bump for CREATE ([#2684](https://github.com/mantle-xyz/revm/pull/2684))
...
- store coinbase address separately to avoid cloning warm addresses in the common case ([#2634](https://github.com/mantle-xyz/revm/pull/2634))
...
- add TxEnvBuilder::build_fill ([#2536](https://github.com/mantle-xyz/revm/pull/2536))
...
- make blob params u64 ([#2385](https://github.com/mantle-xyz/revm/pull/2385))
...
- add EIP-170 contract code size limit tests ([#2312](https://github.com/mantle-xyz/revm/pull/2312))
- Remove LATEST variant from SpecId enum ([#2299](https://github.com/mantle-xyz/revm/pull/2299))
- add unit test for EIP-3860 initcode size limit ([#2302](https://github.com/mantle-xyz/revm/pull/2302))
...
- remove wrong `&mut` and duplicated spec ([#2276](https://github.com/mantle-xyz/revm/pull/2276))
- Add custom instruction example ([#2261](https://github.com/mantle-xyz/revm/pull/2261))
- use AccessListItem associated type instead of AccessList ([#2214](https://github.com/mantle-xyz/revm/pull/2214))
...
- add debug to precompiles type ([#2193](https://github.com/mantle-xyz/revm/pull/2193))
...
- remove CTX phantomdata from precompile providers ([#2178](https://github.com/mantle-xyz/revm/pull/2178))
...
- op-revm cleanup and few docs ([#2156](https://github.com/mantle-xyz/revm/pull/2156))
...
- remove unused source file ([#2133](https://github.com/mantle-xyz/revm/pull/2133))
...
- relax trait req in EthPrecompiles::default ([#2071](https://github.com/mantle-xyz/revm/pull/2071))
