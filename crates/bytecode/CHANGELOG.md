...
## [11.0.0](https://github.com/mantle-xyz/revm/compare/revm-bytecode-v10.0.0...revm-bytecode-v11.0.0) - 2026-08-04
...
- impl `Sealable` for `Bytecode` ([#3118](https://github.com/mantle-xyz/revm/pull/3118))
...
- make Bytecode Ord consistent with PartialEq and Hash ([#3479](https://github.com/mantle-xyz/revm/pull/3479))
- add a test utility function to generate memory input opcodes ([#3280](https://github.com/mantle-xyz/revm/pull/3280))
- *(bytecode)* add padding for final opcode missing immediates ([#3338](https://github.com/mantle-xyz/revm/pull/3338))
- *(bytecode)* improve analyze_legacy and stack tests ([#3335](https://github.com/mantle-xyz/revm/pull/3335))
- the LOG[0-4] CREATE CREATE2 opcode can modify memory ([#3328](https://github.com/mantle-xyz/revm/pull/3328))
- *(bytecode)* improve analyze_legacy padding for SWAPN/DUPN/EXCHANGE ([#3332](https://github.com/mantle-xyz/revm/pull/3332))
- *(bytecode)* remove duplicate implementation in bytes_ref method ([#3276](https://github.com/mantle-xyz/revm/pull/3276))
- the MLOAD opcode can resize memory ([#3266](https://github.com/mantle-xyz/revm/pull/3266))
...
- *(tests)* remove redundant clones in legacy analysis tests ([#3317](https://github.com/mantle-xyz/revm/pull/3317))
...
- the KECCAK256 opcode can resize memory ([#3269](https://github.com/mantle-xyz/revm/pull/3269))
...
- use JumpTable old serde format ([#3101](https://github.com/mantle-xyz/revm/pull/3101))
