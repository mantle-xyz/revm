...
## [12.0.0](https://github.com/mantle-xyz/revm/compare/revm-state-v11.0.1...revm-state-v12.0.0) - 2026-08-04
...
- Account helper builder functions ([#2355](https://github.com/mantle-xyz/revm/pull/2355))
...
- *(state)* re-baseline SSTORE original_value only across tx boundaries
- *(bal)* record storage writes to zero for selfdestructed accounts ([#3573](https://github.com/mantle-xyz/revm/pull/3573))
- set transition_id to account ([#3353](https://github.com/mantle-xyz/revm/pull/3353))
...
- manally implementation PartialOrd and Ord for AccountInfo ([#2835](https://github.com/mantle-xyz/revm/pull/2835))
...
- *(state)* avoid unnecessary clone, prealloc, and fix typo ([#3387](https://github.com/mantle-xyz/revm/pull/3387))
...
- deduplicate local/global flags setup ([#3190](https://github.com/mantle-xyz/revm/pull/3190))
...
- *(state)* remove unnecessary core::hash::Hash import from lib.rs ([#2959](https://github.com/mantle-xyz/revm/pull/2959))
- add SECURITY.md ([#2956](https://github.com/mantle-xyz/revm/pull/2956))
- use primitives::HashMap default ([#2916](https://github.com/mantle-xyz/revm/pull/2916))
...
- add AccountInfo setters ([#2429](https://github.com/mantle-xyz/revm/pull/2429))
...
- *(state)* Add AccountInfo builder util methods ([#2357](https://github.com/mantle-xyz/revm/pull/2357))
...
- inline more `AccountInfo` fns and add docs ([#1819](https://github.com/mantle-xyz/revm/pull/1819))
