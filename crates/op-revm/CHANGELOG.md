...
## [12.0.0](https://github.com/mantle-xyz/revm/compare/op-revm-v11.1.1...op-revm-v12.0.0) - 2025-12-08
...
- Persist BVM_ETH mint for failed deposit like op-geth (pre-snapshot effect). ([#12](https://github.com/mantle-xyz/revm/pull/12))
- eth_value is zero
